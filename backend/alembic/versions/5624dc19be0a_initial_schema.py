...
Revision ID: 5624dc19be0a
Revises: 
Create Date: 2026-03-31 00:46:54.238485
...
def upgrade() -> None:
    ...
    sa.Column('split_type', sa.Enum('EQUAL', 'EXACT', 'PERCENTAGE', name='splittypeenum'), nullable=True),
    ...
    sa.Column('currency', sa.String(length=3), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('status', sa.Enum('PENDING', 'COMPLETED', 'CANCELLED', name='settlementstatusenum'), nullable=True),
